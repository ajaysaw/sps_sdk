...
class ConfirmationPanDropDownAdapter(val context: Context, var listItemsTxt: ArrayList<DocProofType>) : BaseAdapter() {
    ...
    fun updateData(newList: ArrayList<DocProofType>){
