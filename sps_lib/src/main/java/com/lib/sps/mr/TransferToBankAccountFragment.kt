 ...
 * Use the [TransferToBankAccountFragment.newInstance] factory method to
...
class TransferToBankAccountFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment TransferToBankAccountFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            TransferToBankAccountFragment().apply {
